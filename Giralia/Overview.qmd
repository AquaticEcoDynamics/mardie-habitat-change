...
## Eco-Geomorphic Modelling Approach

Predicting mangrove response to SLR requires accounting for eco-geomorphic feedbacks and tidal inundation limits [@Woodroffe2016]. While inundation dynamics depend on coastal slope, sediment supply, and hydrodynamics [@FitzGerald2008; @Passeri2015; @Xie2022], modelling approaches vary in scale and capability:
...
* **Coupled Bio-Morphodynamic Models:** Hybrid frameworks (e.g., *DFMFON*, *BASEveg*) integrate biological dynamics with physical drivers [@Willemsen2022; @Beselly2023; @Caponi2023]. However, computational constraints have largely restricted their application to idealised or small-scale domains.

To overcome these limitations, we coupled **DFM** [@Kernkamp2011] with **NBSDynamics** [@Deltares2022], a Python-based vegetation module. Optimised for parallel execution on High-Performance Computing (HPC) platforms, this framework enables regional-scale eco-geomorphic simulations while preserving process-based vegetation–hydrodynamic–morphological feedbacks.

The primary objective of this study is to quantify how projected SLR scenarios alter the spatial extent and resilience of mangrove forests (*Avicennia marina*) within Giralia Bay.
